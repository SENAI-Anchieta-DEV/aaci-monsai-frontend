    ...
    >
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2, px: 1 }}>
          ...
          {onLogin && (
            <Button onClick={onLogin} variant="outlined" sx={{ borderColor: "#2a5c14", color: "#2a5c14", textTransform: "none", borderRadius: 28 }}>
              Acessar Painel
            </Button>
          )}
        </Box>
        ...
        <Box sx={{
          ...
          <Box sx={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", gap: 2 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1, pl: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: "#333", display: "flex", alignItems: "center" }}>
                • Acelerômetro de Alta Precisão (Detecção de Quedas Bruscas)
              </Typography>
              <Typography variant="body2" sx={{ color: "#333", display: "flex", alignItems: "center" }}>
